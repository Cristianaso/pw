    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipoLocal', models.ForeignKey(to='resultados.Equipo')),
            ],
        ),
        migrations.CreateModel(
            name='Resultado',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('golesLocal', models.CharField(default=b'-', max_length=10)),
                ('golesVisitante', models.CharField(default=b'-', max_length=10)),
                ('nombreLocal', models.CharField(max_length=20)),
                ('nombreVisitante', models.CharField(max_length=20)),
                ('partido', models.ForeignKey(to='resultados.Partido')),
            ],
        ),
    ]
